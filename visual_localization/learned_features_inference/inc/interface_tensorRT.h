#ifndef TENSORRT_DEMO_INTERFACE_H
#define TENSORRT_DEMO_INTERFACE_H
#include <string>
...
class InterfaceTensorRT
{
public:
    InterfaceTensorRT(std::string type, const std::string& modelPath, bool isGPU, cv::Size inputSize,
